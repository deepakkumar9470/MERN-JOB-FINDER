  ...
  return (
    <div>
      <Menu as="div" className="inline-block text-left">
        <div className="flex">
          <Menu.Button className='inline-flex gap-2 w-full rounded-md bg-white md:px-4 py-2 text-sm font-medium text-slate-700 hover:bg-[#f5fafc] transition-all duration-100 '>
          <div className='leading[80px] flex flex-col items-start'>
            ...
            <img
              src={user?.profileUrl ?user?.profileUrl: "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=600"}
              alt='user profile'
      ...
      <div className='relative bg-[#f7fdfd] z-50'>
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div className="flex items-center gap-2">
            <img className="w-8 h-8" src={JobSearch} alt="job" />
